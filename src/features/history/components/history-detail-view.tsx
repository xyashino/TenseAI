import { transformSessionDataToChatComponents } from "@/features/training-session/utils/transform-session";
import type { SessionDetailResponseDTO } from "@/features/training/types";
