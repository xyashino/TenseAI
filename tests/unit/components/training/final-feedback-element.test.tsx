import { FinalFeedbackElement } from "@/features/training-session/components/chat-components/final-feedback-element/final-feedback-element";
import { render, screen } from "../../test-utils";

vi.mock("@/features/training-session/components/chat-components/final-feedback-element/final-feedback-header", () => ({
...
vi.mock("@/features/training-session/components/chat-components/final-feedback-element/rounds-scores-display", () => ({
  RoundsScoresDisplay: ({ roundsScores }: { roundsScores: number[] }) => (
    <div data-test-id="rounds-scores">Scores: {roundsScores.join(", ")}</div>
  ),
}));

vi.mock("@/features/training-session/components/chat-components/final-feedback-element/stats-grid", () => ({
...
vi.mock("@/features/training-session/components/chat-components/final-feedback-element/detailed-analysis", () => ({
  DetailedAnalysis: ({ finalFeedback }: { finalFeedback: string }) => (
    <div data-test-id="detailed-analysis">{finalFeedback}</div>
  ),
}));

vi.mock("@/features/training-session/components/chat-components/final-feedback-element/final-feedback-actions", () => ({
